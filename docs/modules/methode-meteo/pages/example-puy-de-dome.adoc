= Exemple : Vol au Puy de Dôme le 27-28 janvier 2024
:Author: Dhrions
...
:toc-title: Sommaire
:icons: font
:description: Exemple d'analyse météo pour un vol au Puy de Dôme
:keywords: Parapente, météo, Puy de Dôme, exemple
...
Inconsciemment, j'ai suivi la méthode décrite dans xref:index.adoc[ce document] et j'ai commencé directement à la méso-échelle. Je me suis posé les questions suivantes :
